...
function buildJs() {
  ...
  // copy custom.js
  src(`${dir.src}js/custom.js`).pipe(dest(`${dir.build}js`));
  src(`${dir.src}js/jquery-3.2.1.min.js`).pipe(dest(`${dir.build}js`));
  src(`${dir.src}js/swiper-bundle.min.js`).pipe(dest(`${dir.build}js`));
